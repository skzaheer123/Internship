...
st.markdown('<p style="{}"> 👀 AI Data Science educator </p>'.format(";".join([f"{k}:{v}" for k, v in title_style.items()])), unsafe_allow_html=True)


f = open(r"C:\Users\User\Downloads\DA\Internship\Gen_ai_code_reviewer\key\new_Key.txt")
api_key = f.read()
...
if "messages" not in st.session_state.keys():
    st.session_state.messages = [
        {"role": "assistant", "content": "Hello, this is GeminiAI and how I can help you today?"}
    ]
    st.title("📢:rainbow[Hello AI guys, How may I assist you today?]")
